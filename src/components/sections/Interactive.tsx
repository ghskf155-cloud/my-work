...
export default function Interactive() {
  return (
    <div className="bg-stone-50 text-stone-900 font-sans w-full">
      ...
      <section id="utility" className="min-h-screen py-24 px-6 md:px-12 flex flex-col justify-center border-b border-stone-200 scroll-mt-20">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white border border-stone-200 rounded-3xl p-8 h-[500px] flex items-center justify-center relative overflow-hidden group shadow-md">
            <Image src="/utility.png" alt="HUMANICS Utility" fill sizes="(max-width: 1024px) 100vw, 50vw" className="w-full h-full object-contain rounded-2xl opacity-80 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-2 md:row-span-2 relative min-h-[400px] md:min-h-full rounded-3xl overflow-hidden group border border-stone-200 shadow-sm">
               <Image src="/design/gentle.png" alt="Gentle" fill sizes="(max-width: 768px) 100vw, 50vw" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="relative h-[250px] rounded-3xl overflow-hidden group border border-stone-200 shadow-sm">
               <Image src="/design/knit_suit.png" alt="Knit Suit" fill sizes="(max-width: 768px) 100vw, 25vw" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="relative h-[250px] rounded-3xl overflow-hidden group border border-stone-200 shadow-sm">
               <Image src="/design/tendon.png" alt="Tendon-Driven" fill sizes="(max-width: 768px) 100vw, 25vw" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent flex items-end p-6">
            ...
            <div className="relative h-[250px] rounded-3xl overflow-hidden group border border-stone-200 shadow-sm">
               <Image src="/design/soft_body.png" alt="Soft Body" fill sizes="(max-width: 768px) 100vw, 25vw" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent flex items-end p-6">
            ...
            <div className="relative h-[250px] rounded-3xl overflow-hidden group border border-stone-200 shadow-sm">
               <Image src="/design/emotive.jpg" alt="Emotive Ear Ring" fill sizes="(max-width: 768px) 100vw, 25vw" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
               <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent flex items-end p-6">
      ...
      <section id="companion-section" className="min-h-screen py-24 px-6 md:px-12 flex flex-col justify-center border-b border-stone-200 scroll-mt-20">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div id="companion" className="space-y-8 scroll-mt-28">
          ...
          <div id="intelligence" className="space-y-8 scroll-mt-28">
